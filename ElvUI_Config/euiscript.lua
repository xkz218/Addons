				...
				uiGroup = {
					...
					args = {
						...
						tabold = {
							type = 'toggle',
							order = 36,
							name = L["Old Tab target"],
							set = function(info,value) E.db.euiscript.tabold = value;
								if value then
							...
							get = function(info) return E.db.euiscript.tabold; end,
						},
						CrucibleWeight = {
							type = 'toggle',
							order = 37,
							name = L["CrucibleWeight"],
							set = function(info,value) E.db.euiscript.CrucibleWeight = value; E:StaticPopup_Show("CONFIG_RL"); end,
							get = function(info) return E.db.euiscript.CrucibleWeight; end,
						},
					},
				},
				questGroup = {
