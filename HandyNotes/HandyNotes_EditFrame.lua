...
HNEditFrame.icondropdown = CreateFrame("Frame", "HandyNotes_IconDropDown", HNEditFrame, "L_UIDropDownMenuTemplate")
...
L_UIDropDownMenu_SetWidth(HNEditFrame.icondropdown, 120)
L_UIDropDownMenu_EnableDropDown(HNEditFrame.icondropdown)
...
HNEditFrame.leveldropdown = CreateFrame("Frame", "HandyNotes_LevelDropDown", HNEditFrame, "L_UIDropDownMenuTemplate")
...
L_UIDropDownMenu_SetWidth(HNEditFrame.leveldropdown, 282)
L_UIDropDownMenu_EnableDropDown(HNEditFrame.leveldropdown)
...
HNEditFrame:SetScript("OnShow", function(self)
	...
	if data then
		...
		if HNEditFrame.leveldata[0] then
			...
			L_UIDropDownMenu_DisableDropDown(HNEditFrame.leveldropdown)
