...
G.unitframe.aurafilters['RaidDebuffs'] = {
	...
	['spells'] = {
	--user erport
		[247367] = Defaults(), --Õð»÷Ö®Ç¹
		[257978] = Defaults(), --ÈÛÖýÖ®»÷
		[245990] = Defaults(), --Ì©É³À­¿ËÖ®´¥
...
local function ClassBuff(id, point, color, anyUnit, onlyShowMissing, style, displayText, decimalThreshold, textColor, textThreshold, xOffset, yOffset, sizeOverride, haveAnimation)
	...
	['textColor'] = {["r"] = r2, ["g"] = g2, ["b"] = b2}, ['textThreshold'] = textThreshold or -1, ['xOffset'] = xOffset or 0, ['yOffset'] = yOffset or 0, ["sizeOverride"] = sizeOverride or 0, ['haveAnimation'] = haveAnimation}
end
