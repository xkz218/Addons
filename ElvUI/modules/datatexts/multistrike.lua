...
local STAT_MULTISTRIKE = STAT_MULTISTRIKE
...
DT:RegisterDatatext('Multistrike', {"UNIT_STATS", "UNIT_AURA", "ACTIVE_TALENT_GROUP_CHANGED", "PLAYER_TALENT_UPDATE", "PLAYER_DAMAGE_DONE_MODS"}, OnEvent, nil, nil, OnEnter)