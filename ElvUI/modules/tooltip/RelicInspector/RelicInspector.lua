...
if GetLocale() == "zhCN" then
	LL["RelicInspector"] = "圣物观察"
	LL["Enable"] = "启用"
	LL["Enables / Disables RelicInspector"] = "启用 / 禁用圣物观察"
	LL["Item Level To Display:"] = "物品等级显示:"
	LL["Whether to show relic item level or weapon gain"] = "显示圣物物品等级或增益"
	LL["Artifact Item Tooltips"] = "神器物品鼠标提示"
	LL["Show Trait Names:"] = "显示特质的名字:"
	LL["When to show trait names on artifact tooltips"] = "当显示特质的名字在神器鼠标提示上"
	LL["Show Trait Descriptions:"] = "显示特质的描述信息:"
	LL["When to show trait descriptions on artifact tooltips"] = "显示特质的描述信息在神器提示信息"
	LL["Artifact Link Tooltips"] = "神器链结提示"
	LL["Show Trait Names:"] = "显示特质名字"
	LL["When to show trait names on link tooltips"] = "显示特质的名字在链结的鼠标提示"
	LL["Show Trait Descriptions:"] = "显示特质描述"
	LL["When to show trait descriptions on link tooltips"] = "显示特质的描述信息在链结提示信息"
	LL["Relic Tooltips"] = "圣物鼠标提示"
	LL["Unequipped Artifact Traits to Show:"] = "未装备神器特质显示"
	LL["Which unequipped artifacts to show relic traits for"] = "未装备神器特质显示"
	LL["Show Spec Requirements on Relics:"] = "在圣物上显示天赋需求"
	LL["What spec information to show on relics"] = "在圣物上显示天赋需求信息"
	LL["Show "] = "显示 "
	LL["When to show Netherlight Crucible traits on artifact tooltips"] = "在神器鼠标提示中显示虚空之光熔炉"
elseif GetLocale() == "zhTW" then
	LL["RelicInspector"] = "聖物觀察"
	LL["Enable"] = "啟用"
	LL["Enables / Disables RelicInspector"] = "啟用 / 禁用聖物觀察"
	LL["Item Level To Display:"] = "物品等級顯示:"
	LL["Whether to show relic item level or weapon gain"] = "顯示聖物物品等級或增益"
	LL["Artifact Item Tooltips"] = "神器物品滑鼠提示"
	LL["Show Trait Names:"] = "顯示特質的名字:"
	LL["When to show trait names on artifact tooltips"] = "當顯示特質的名字在神器滑鼠提示上"
	LL["Show Trait Descriptions:"] = "顯示特質的描述資訊:"
	LL["When to show trait descriptions on artifact tooltips"] = "顯示特質的描述資訊在神器提示資訊"
	LL["Artifact Link Tooltips"] = "神器鏈結提示"
	LL["Show Trait Names:"] = "顯示特質名字"
	LL["When to show trait names on link tooltips"] = "顯示特質的名字在鏈結的滑鼠提示"
	LL["Show Trait Descriptions:"] = "顯示特質描述"
	LL["When to show trait descriptions on link tooltips"] = "顯示特質的描述資訊在鏈結提示資訊"
	LL["Relic Tooltips"] = "聖物滑鼠提示"
	LL["Unequipped Artifact Traits to Show:"] = "未裝備神器特質顯示"
	LL["Which unequipped artifacts to show relic traits for"] = "未裝備神器特質顯示"
	LL["Show Spec Requirements on Relics:"] = "在聖物上顯示天賦需求"
	LL["What spec information to show on relics"] = "在聖物上顯示天賦需求資訊"
	LL["Show "] = "顯示 "
	LL["When to show Netherlight Crucible traits on artifact tooltips"] = "在神器滑鼠提示中顯示虛空之光熔爐"
else
	LL["RelicInspector"] = "RelicInspector"
	LL["Enable"] = "Enable"
	LL["Enables / Disables RelicInspector"] = "Enables / Disables RelicInspector"
	LL["Item Level To Display:"] = "Item Level To Display:"
	LL["Whether to show relic item level or weapon gain"] = "Whether to show relic item level or weapon gain"
	LL["Artifact Item Tooltips"] = "Artifact Item Tooltips"
	LL["Show Trait Names:"] = "Show Trait Names:"
	LL["When to show trait names on artifact tooltips"] = "When to show trait names on artifact tooltips"
	LL["Show Trait Descriptions:"] = "Show Trait Descriptions:"
	LL["When to show trait descriptions on artifact tooltips"] = "When to show trait descriptions on artifact tooltips"
	LL["Artifact Link Tooltips"] = "Artifact Link Tooltips"
	LL["Show Trait Names:"] = "Show Trait Names:"
	LL["When to show trait names on link tooltips"] = "When to show trait names on link tooltips"
	LL["Show Trait Descriptions:"] = "Show Trait Descriptions:"
	LL["When to show trait descriptions on link tooltips"] = "When to show trait descriptions on link tooltips"
	LL["Relic Tooltips"] = "Relic Tooltips"
	LL["Unequipped Artifact Traits to Show:"] = "Unequipped Artifact Traits to Show:"
	LL["Which unequipped artifacts to show relic traits for"] = "Which unequipped artifacts to show relic traits for"
	LL["Show Spec Requirements on Relics:"] = "Show Spec Requirements on Relics:"
	LL["What spec information to show on relics"] = "What spec information to show on relics"
	LL["Show "] = "Show "
	LL["When to show Netherlight Crucible traits on artifact tooltips"] = "When to show Netherlight Crucible traits on artifact tooltips"
end	
		...
		args = {
			general = {
				...
				args = {
					enabled = {
						name = LL["Enable"],
						desc = LL["Enables / Disables RelicInspector"],
						type = "toggle",
						width = "double",
					...
					itemLevelChoice = {
						name = LL["Item Level To Display:"],
						desc = LL["Whether to show relic item level or weapon gain"],
						type = "select",
						width = "double",
					...
					itemTooltipTraitNames = {
						name = LL["Show Trait Names:"],
						desc = LL["When to show trait names on artifact tooltips"],
						type = "select",
						width = "single",
					...
					itemTooltipTraitDesc = {
						name = LL["Show Trait Descriptions:"],
						desc = LL["When to show trait descriptions on artifact tooltips"],
						type = "select",
						width = "single",
					...
					itemTooltipNetherlight = {
						name = LL["Show "] .. SPLASH_LEGION_NEW_7_3_FEATURE1_TITLE .. " " .. ARTIFACTS_PERK_TAB .. ":",
						desc = LL["When to show Netherlight Crucible traits on artifact tooltips"],
						type = "select",
						width = "single",
					...
					linkTooltipHeader = {
						name = LL["Artifact Link Tooltips"],
						type = "header",
						order = 30
					},
					linkTooltipTraitNames = {
						name = LL["Show Trait Names:"],
						desc = LL["When to show trait names on link tooltips"],
						type = "select",
						width = "single",
					...
					linkTooltipTraitDesc = {
						name = LL["Show Trait Descriptions:"],
						desc = LL["When to show trait descriptions on link tooltips"],
						type = "select",
						width = "single",
					...
					relicTooltipHeader = {
						name = LL["Relic Tooltips"],
						type = "header",
						order = 40
					},
					relicTooltipOffspecs = {
						name = LL["Unequipped Artifact Traits to Show:"],
						desc = LL["Which unequipped artifacts to show relic traits for"],
						type = "select",
						width = "double",
					...
					relicSpecs = {
						name = LL["Show Spec Requirements on Relics:"],
						desc = LL["What spec information to show on relics"],
						type = "select",
						width = "double",
