...
function E:CreateCooldownTimer(parent)
	...
	text:Point('CENTER', parent.offsetX or 1, parent.offsetY or 1)
...
function E:RegisterCooldown(cooldown, offsetX, offsetY)
	...
	cooldown.offsetX = offsetX
	cooldown.offsetY = offsetY
