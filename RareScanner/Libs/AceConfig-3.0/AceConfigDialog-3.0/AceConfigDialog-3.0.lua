...
-- Modified to order the table by keys in multiselect type
local MAJOR, MINOR = "AceConfigDialog-3.0-RSmod", 61
		...
		if not hidden then
			if v.type == "group" then
				...
				elseif v.type == "multiselect" then
					...
					local valuesort = new()
					if values then
						for value, text in AceConfigDialog:orderedPairs(values) do
...
function AceConfigDialog:orderedPairs(t)
