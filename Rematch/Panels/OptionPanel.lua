...
panel.opts = {
   ...
   { "check", "LoadHealthiestAny", L["Allow Any Version"]..newIcon, L["Instead of choosing only the healthiest pet with identical stats, choose the healthiest version of the pet regardless of stats."], "LoadHealthiest" },
