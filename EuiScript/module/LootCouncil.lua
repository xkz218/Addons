...
local function GuildRank_OnClick(self)
	L_UIDropDownMenu_SetSelectedValue(MinGuildRankDropdown, self.value);
...
local function GuildRank_Initialize()
	...
	L_UIDropDownMenu_SetSelectedValue(MinGuildRankDropdown, guildRanks[LC.db.minRank]);
end

local function BroadcastChannel_OnClick(self)
	L_UIDropDownMenu_SetSelectedValue(BroadcastChannelDropdown, self.value);
...
local function BroadcastChannel_Initialize()
	...
	L_UIDropDownMenu_SetSelectedValue(BroadcastChannelDropdown, broadcastChannels[LC.db.broadcastChannel]);
end
...
function LC:CreateLC()
	...
	local guildRank = CreateFrame('Frame', 'MinGuildRankDropdown', config, 'L_UIDropDownMenuTemplate')
	...
	L_UIDropDownMenu_SetWidth(MinGuildRankDropdown, 85);
	L_UIDropDownMenu_JustifyText(MinGuildRankDropdown, "LEFT");
	L_UIDropDownMenu_Initialize(guildRank, GuildRank_Initialize);		

	--Broadcast Channel
	local broadcastChannel = CreateFrame('Frame', 'BroadcastChannelDropdown', config, 'L_UIDropDownMenuTemplate')
	...
	L_UIDropDownMenu_SetWidth(BroadcastChannelDropdown, 85);
	L_UIDropDownMenu_JustifyText(BroadcastChannelDropdown, "LEFT");
	L_UIDropDownMenu_Initialize(broadcastChannel, BroadcastChannel_Initialize);				
